...
1. Select your Workspace (1) in the left pane, then click on **+ New Item **. In the popout window scroll a little bit down and select **Eventstream (2)**.
...
1. Navigate back to **your workspace (1)** that you have created.
...
1. Open your Eventstream in your Fabric Workspace by clicking on your **workspace (1)** icon in the left pane, and then navigating to **Eventstream WebEventStream_ES (2)**.
